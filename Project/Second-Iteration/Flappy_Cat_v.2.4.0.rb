require 'rubygems'	
	...
	file6 = File.expand_path("hardness.png", this_dir)
	file7 = File.expand_path("easy.png", this_dir)
	file8 = File.expand_path("play.png", this_dir)
	file9 = File.expand_path("exit.png", this_dir)
	file10 = File.expand_path("medium.png", this_dir)
	file11 = File.expand_path("hard.png", this_dir)
	...
	image6 = Surface.load( file6 )
	image7 = Surface.load( file7 )
	image8 = Surface.load( file8 )
	image9 = Surface.load( file9 )
	image10 = Surface.load( file10 )
	image11 = Surface.load( file11 )
